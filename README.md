...
* Kubernetes v1.7.8, Docker engine 1.12.6, etcd v3
...
* [Hashicorp Vault 0.8.3](https://www.vaultproject.io/) service with PKI mount to manage Kubernetes certificates, i.e. create and renew automatically.
